...
rec {
  ...
  deps = [ args."cl-ppcre" args."cl-unicode_slash_base" args."flexi-streams" ];
...
/* (SYSTEM cl-unicode DESCRIPTION Portable Unicode Library SHA256
    ...
    ((NAME cl-ppcre FILENAME cl-ppcre)
     (NAME cl-unicode/base FILENAME cl-unicode_slash_base)
     (NAME flexi-streams FILENAME flexi-streams))
    DEPENDENCIES (cl-ppcre cl-unicode/base flexi-streams) VERSION 20180131-git
    SIBLINGS NIL PARASITES (cl-unicode/base cl-unicode/build cl-unicode/test)) */
