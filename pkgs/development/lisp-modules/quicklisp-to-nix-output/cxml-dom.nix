...
rec {
  ...
  parasites = [ "cxml" "cxml-klacks" "cxml-test" "cxml-xml" ];
  ...
  asdFilesToKeep = ["cxml-dom.asd"];
  overrides = x: x;
}
/* (SYSTEM cxml-dom DESCRIPTION NIL SHA256
    ...
    587755dff60416d4f716f4e785cf747e NAME cxml-dom FILENAME cxml-dom DEPS
    ...
    (cxml cxml-klacks cxml-test cxml-xml)) */
