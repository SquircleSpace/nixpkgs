...
rec {
  ...
  parasites = [ "iolib" "iolib/os" "iolib/pathnames" "iolib/sockets" "iolib/streams" "iolib/syscalls" "iolib/trivial-sockets" "iolib/zstreams" ];

  description = ''I/O multiplexing library.'';

  deps = [ args."alexandria" args."cffi" args."iolib_dot_asdf" args."iolib_dot_base" args."iolib_dot_conf" args."iolib_slash_syscalls" args."split-sequence" ];
  ...
  asdFilesToKeep = ["iolib/multiplex.asd"];
  overrides = x: x;
}
/* (SYSTEM iolib/multiplex DESCRIPTION I/O multiplexing library. SHA256
    ...
    fc28d4cad6f8e43972df3baa6a8ac45c NAME iolib/multiplex FILENAME
    iolib_slash_multiplex DEPS
    ...
    DEPENDENCIES
    (alexandria cffi iolib.asdf iolib.base iolib.conf iolib/syscalls
     split-sequence)
    ...
    PARASITES
    (iolib iolib/os iolib/pathnames iolib/sockets iolib/streams iolib/syscalls
